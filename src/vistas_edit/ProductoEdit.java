 ...
 * @author Ronald
 */
public class ProductoEdit extends javax.swing.JDialog {
    ProductoJpaController p = new ProductoJpaController();
    Producto producto = new Producto();
    /**
     * Creates new form ProductoEdit
     */
    public ProductoEdit(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel2.add(jButton3, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 70, 110, -1));
        ...
        jPanel2.add(jButton4, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 120, 110, -1));
        ...
        // TODO add your handling code here:
            ...
            if(fila == -1){
                ...
                if(fila >= 0){
                    ...
                    txtStock.setText(producto.getPrecio());
                    txtEstado.setSelectedItem(producto.getEstadoCodigo());
                }
            }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ProductoEdit.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ProductoEdit dialog = new ProductoEdit(new javax.swing.JFrame(), true);
