...
public class frmLogin extends javax.swing.JDialog {
    ...
    private void jLabel5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jLabel5MouseClicked
        ...
        if(txtUsuario.getText().equals("Ingrese su usuario") || txtClave.getPassword().equals("********")){
            JOptionPane.showMessageDialog(null, "Llenar campos");
        }
        else{
            int user = Integer.parseInt(txtUsuario.getText());
            String clave = new String(txtClave.getPassword());
            VendedorJpaController vp = new VendedorJpaController();
            Vendedor vendedor = vp.findVendedor(user);
